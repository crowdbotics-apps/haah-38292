"""
Django settings for haah_38292 project.
...
WSGI_APPLICATION = 'haah_38292.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "haah_38292 API",
    "DESCRIPTION": "API documentation for haah_38292 App",
    "VERSION": "v1",
}
